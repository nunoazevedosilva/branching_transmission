...
class simulation_config:
    ...
    """
    def __init__(self, dims, Nx, Ny, Nt, Nz, total_steps, stride,dx,dy,dz,dt,number_nl_numbers, number_nl_vectors, saveDir):
    ...
    def gen_config_file(self,nl_numbers,nl_vectors):
        ...
        L0= [self.dims, self.Nx, self.Ny, self.Nt, self.Nz, 
            ...
            self.dt,self.number_nl_numbers, self.number_nl_vectors, self.saveDir]
        L = [str(i)+'\n' for i in L0]
        try:
            os.mkdir('config_folder')
        except:
